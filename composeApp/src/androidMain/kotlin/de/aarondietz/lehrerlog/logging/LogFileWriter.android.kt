...
private var androidLogContext: Context? = null

fun initAndroidLogFileWriter(context: Context) {
    androidLogContext = context.applicationContext
}
...
actual class LogFileWriter {
    ...
    private fun resolveLogBaseDir(): File {
        val context = androidLogContext
        return if (context != null) {
            context.cacheDir
        } else {
            File(System.getProperty("java.io.tmpdir"), "lehrerlog")
        }
    }
